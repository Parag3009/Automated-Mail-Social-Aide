...
app.config['MAIL_USERNAME'] = 'paragit09.com'
app.config['MAIL_PASSWORD'] = 'Par_ag@3886'
...
def send_mail():
    df = pd.read_excel (r'D:\Sem-4\Mini\MIN.xlsx')
...
def admin():
    ...
    engine = create_engine("postgresql://postgres:Par_ag_3886@localhost:3886/Registered")
...
def memberUpdate():
    ...
    try:
        ...
        error="Invalid Date. Please enter again."
        return render_template("update3.html",error=error)
